...
<html>
    ...
    <body>
        ...
        <p>Type decoration ID# here to add to cart <input type="addDecor" name="addDecorTb" placeholder="Enter ID Here"> <input type="quant" name="quantTb" placeholder="Quantity">  <button>Add to Cart</button> </p>

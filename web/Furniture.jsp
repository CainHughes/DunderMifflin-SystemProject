<%-- 
    Document   : Furniture
    Created on : Apr 17, 2019, 4:18:04 PM
    Author     : GC3
--%>
...
<html>
    ...
    <body>
        ...
        <p>Type furniture ID# here to add to cart <input type="addFurn" name="addFurnTb" placeholder="Enter ID Here"> <input type="quant" name="quantTb" placeholder="Quantity">  <button>Add to Cart</button> </p>
